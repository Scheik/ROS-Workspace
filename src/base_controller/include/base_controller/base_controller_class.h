...
void BaseController::cmd_vel_callback(const geometry_msgs::Twist& vel_cmd)
{
    ...
    if (vel_cmd.angular.z != 0 && vel_cmd.linear.x==0){
				// MD49 Mode = 0 *************************************
				requested_speed_l = 128 - ((127/max_linear_x)*vel_cmd.angular.z);
			  requested_speed_r = 128 + ((127/max_linear_x)*vel_cmd.angular.z);
...
* @brief This function opens serial port MD49 is connected to
*/
void BaseController::open_serialport()
{
...
* @brief This function reads encodervalues from MD49 and publishes them as topic /md49_encoders
*/
void BaseController::publish_encoders()
{
    get_encoders();
...
* @brief This function reads data and parameters from MD49 and publishes them as topic /md49_data
*/
void BaseController::publish_md49_data()
{
...
* @param regulator
*/
void BaseController::init_md49(int speed_l, int speed_r, int mode, int acceleration, bool timeout, bool regulator)
{
...
* @param speed_r
*/
void BaseController::set_speed(int speed_l, int speed_r)
{
...
* @param mode
*/
void BaseController::set_mode(int mode)
{
...
* @param acceleration
*/
void BaseController::set_acceleration(int acceleration)
{
...
* @brief This function enables timeout on MD49
*/
void BaseController::enable_timeout(void)
{
...
* @brief This function enables regulator on MD49
*/
void BaseController::enable_regulator(void)
{
...
* @brief This function disables Timeout on MD49
*/
void BaseController::disable_timeout(void)
{
...
* @brief This function disables regulator on MD49
*/
void BaseController::disable_regulator(void)
{
...
* @return
*/
int BaseController::get_acceleration()
{
...
* @return
*/
int BaseController::get_speed_l()
{
...
* @return
*/
int BaseController::get_speed_r()
{
...
* @brief This function reads encodervalues from MD49
*/
void BaseController::get_encoders(void)
{
...
* @return
*/
int BaseController::get_current_l()
{
...
* @return
*/
int BaseController::get_current_r()
{
...
int BaseController::get_error()
{
    ...
    //ROS_INFO("Got this reply (error): %i", reply[0]);
		if (reply[0]==128){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 7: UNDER 16V, stops power being switched to the motor because source has dropped below 16V lower threshold. When the supply gets back to 18V the error will clear and power will be outputted again");
		}
		if (reply[0]==64){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 6: OVER 30V, lockout prevents excess voltage being outputted to the motor, the error will be cleared and power outputted when the supply lowers to 28V or below");
		}
		if (reply[0]==32){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 5: MOTOR2 SHORT, indicates a direct short has been detected across motor 2 output. This error will remain until power has been cycled");
		}
		if (reply[0]==16){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 4: MOTOR1 SHORT, indicates a direct short has been detected across motor 1 output. This error will remain until power has been cycled");
		}
		if (reply[0]==48){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 4: MOTOR1+2 SHORT, indicates a direct short has been detected across motor 1+2 output. This error will remain until power has been cycled");
		}
		if (reply[0]==8){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 3: MOTOR2 TRIP, is set when the current drawn by motor 2 is greater than 10A. This error will remain until power has been cycled");
		}
		if (reply[0]==4){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
		...
		if (reply[0]==12){
			ROS_ERROR("Got this reply (error): %i", reply[0]);
			ROS_ERROR("Bit 2+3: MOTOR1+2 TRIP, is set when the current drawn by motor 1+2 is greater than 10A. This error will remain until power has been cycled");
		}
    return reply[0];
}
...
* @brief This function resets encoders on MD49
*/
void BaseController::reset_encoders(void)
{
...
* @return
*/
int BaseController::get_requested_speed_l()
{
...
* @return
*/
int BaseController::get_requested_speed_r()
{
...
* @param speed_l
*/
void BaseController::set_requested_speed_l(int speed_l)
{
...
* @param speed_r
*/
void BaseController::set_requested_speed_r(int speed_r)
{
...
* @return
*/
int BaseController::get_actual_speed_l()
{
...
* @return
*/
int BaseController::get_actual_speed_r()
{
...
* @param speed_l
*/
void BaseController::set_actual_speed_l(int speed_l)
{
...
* @param speed_r
*/
void BaseController::set_actual_speed_r(int speed_r)
{
...
* @return
*/
int BaseController::get_initial_md49_mode()
{
...
* @return
*/
int BaseController::get_initial_md49_acceleration()
{
...
* @return
*/
int BaseController::get_initial_md49_timeout()
{
...
* @return
*/
int BaseController::get_initial_md49_regulator()
{
