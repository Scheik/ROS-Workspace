...
void read_MD49_Data (void){
    ...
    myfile << serialBuffer[2];
    myfile << "\n";
    printf("Byte4: %i \n",serialBuffer[3]);
    myfile << serialBuffer[3];
    myfile << "\n";
    printf("Encoder2 Byte1: %i ",serialBuffer[4]);
    myfile << serialBuffer[4];
    myfile << "\n";
    printf("Byte2: %i ",serialBuffer[5]);
    myfile << serialBuffer[5];
    myfile << "\n";
    printf("Byte3: %i ",serialBuffer[6]);
    myfile << serialBuffer[6];
    myfile << "\n";
    printf("Byte4: %i \n",serialBuffer[7]);
    myfile << serialBuffer[7];
    myfile << "\n";
    ...
    myfile << serialBuffer[8];
    myfile << "\n";
    printf("Speed2: %i \n",serialBuffer[9]);
    myfile << serialBuffer[9];
    myfile << "\n";
    printf("Volts: %i \n",serialBuffer[10]);
    myfile << serialBuffer[10];
    myfile << "\n";
    printf("Current1: %i ",serialBuffer[11]);
    myfile << serialBuffer[11];
    myfile << "\n";
    printf("Current2: %i \n",serialBuffer[12]);
    myfile << serialBuffer[12];
    myfile << "\n";
    printf("Error: %i \n",serialBuffer[13]);
    myfile << serialBuffer[13];
    myfile << "\n";
    printf("Acceleration: %i \n",serialBuffer[14]);
    myfile << serialBuffer[14];
    myfile << "\n";
    printf("Mode: %i \n",serialBuffer[15]);
    myfile << serialBuffer[15];
    myfile << "\n";
    printf("Regulator: %i \n",serialBuffer[16]);
    myfile << serialBuffer[16];
    myfile << "\n";
    printf("Timeout: %i \n",serialBuffer[17]);
    myfile << serialBuffer[17];
    myfile << "\n";
