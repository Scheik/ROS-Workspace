...
void read_MD49_Data (void){
    ...
    myfile << "\n";
    printf("Byte4: %i \n",serialBuffer[3]);
    myfile <<  printf ("%i",serialBuffer[3]);
    myfile << "\n";
    printf("Encoder2 Byte1: %i ",serialBuffer[4]);
    myfile <<  printf ("%i",serialBuffer[4]);
    myfile << "\n";
    printf("Byte2: %i ",serialBuffer[5]);
    myfile <<  printf ("%i",serialBuffer[5]);
    myfile << "\n";
    printf("Byte3: %i ",serialBuffer[6]);
    myfile <<  printf ("%i",serialBuffer[6]);
    myfile << "\n";
    printf("Byte4: %i \n",serialBuffer[7]);
    myfile <<  printf ("%i",serialBuffer[7]);
    myfile << "\n";
    printf("EncoderL: %i ",EncoderL);
    myfile <<  printf ("%i",EncoderL);
    myfile << "\n";
    printf("EncoderR: %i \n",EncoderR);
    myfile <<  printf ("%i",EncoderR);
    myfile << "\n";
    printf("====================================================== \n");
    printf("Speed1: %i ",serialBuffer[8]);
    myfile <<  printf ("%i",serialBuffer[8]);
    myfile << "\n";
    printf("Speed2: %i \n",serialBuffer[9]);
    myfile <<  printf ("%i",serialBuffer[9]);
    myfile << "\n";
    printf("Volts: %i \n",serialBuffer[10]);
    myfile <<  printf ("%i",serialBuffer[10]);
    myfile << "\n";
    printf("Current1: %i ",serialBuffer[11]);
    myfile <<  printf ("%i",serialBuffer[11]);
    myfile << "\n";
    printf("Current2: %i \n",serialBuffer[12]);
    myfile <<  printf ("%i",serialBuffer[12]);
    myfile << "\n";
    printf("Error: %i \n",serialBuffer[13]);
    myfile <<  printf ("%i",serialBuffer[13]);
    myfile << "\n";
    printf("Acceleration: %i \n",serialBuffer[14]);
    myfile <<  printf ("%i",serialBuffer[14]);
    myfile << "\n";
    printf("Mode: %i \n",serialBuffer[15]);
    myfile <<  printf ("%i",serialBuffer[15]);
    myfile << "\n";
    printf("Regulator: %i \n",serialBuffer[16]);
    myfile <<  printf ("%i",serialBuffer[16]);
    myfile << "\n";
    printf("Timeout: %i \n",serialBuffer[17]);
    myfile <<  printf ("%i",serialBuffer[17]);
    myfile << "\n";
